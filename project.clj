  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "hello-clj.core/on-figwheel-reload"}

                :compiler {:main hello-clj.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/hello_clj.js"
